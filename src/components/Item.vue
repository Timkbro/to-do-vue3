<template>
  <div class="item">
    ...
    <div class="item-btns">
      <button class="item-btn btn-edit" @click="$emit('changeItem', item.id)">
        <img src="@/assets/images/change.png" alt="">
        <span>{{words.editBtn[lang]}}</span>
      </button>
      <button class="item-btn btn-delete" @click="$emit('deleteItem', item.id)">
        <img src="@/assets/images/delete.png" alt="">
        <span>{{words.deleteBtn[lang]}}</span>
      </button>
    </div>
  </div>
</template>
